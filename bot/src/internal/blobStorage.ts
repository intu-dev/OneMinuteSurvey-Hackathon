...
// https://github.com/OfficeDev/TeamsFx-Samples/blob/ga/adaptive-card-notification/bot/src/storage/blobsStorage.ts
export class BlobStorage implements NotificationTargetStorage {
